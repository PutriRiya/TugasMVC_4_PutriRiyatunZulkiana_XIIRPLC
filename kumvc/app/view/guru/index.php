                ...
                <?php foreach ($data['guru'] as $guru) : ?>
                    <li class="list-group-item list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <div class="fload-end">
                            ...
                            <a href="<?= BASE_URL; ?>/guru/hapus/<?= $guru['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data?');">Hapus</a>
        ...
        <div class="content-ubah">
            ...
            <form action="<?= BASE_URL; ?>/guru/getubah" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="jurusan" id="jurusan" class="form-control" value="<?= $i['jurusan']; ?>">
                </div>
